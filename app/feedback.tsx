...
export default function FeedbackScreen() {
  ...
  return (
    <AppScreen>
      <FadeIn>
        <ScreenHeader
          title="Post-Use Feedback"
          subtitle="Capture outcome to improve personalization quality over time."
        />
      </FadeIn>
      ...
      <FadeIn delay={80}>
        <AppCard tone="accent">
          ...
          <AppInput
            ...
            multiline
            placeholder="Any symptoms, timing, and context"
          />

          <AppButton
            label={busy.submittingFeedback ? 'Submitting...' : 'Submit Feedback'}
            onPress={onSubmit}
            disabled={!assessment || busy.submittingFeedback}
          />
